...
const TRANSLATIONS = {
  ...
  ta: { nav_login:"உள்நுழை", nav_join:"சேருங்கள்", sign_in:"உள்நுழை",
        trust_score:"விர்து-நம்பிக்கை மதிப்பு", send_money:"பணம் அனுப்பு",
        virtu_loans:"விர்து-கடன்கள்", emergency_fund:"அவசர நிதி",
        kisan_sahayata:"கிசான் உதவி", laghu_vyapaar:"சிறு வணிகம்",
        gyani_send_money:"Send Money உங்கள் VirtuBank UID அல்லது UPI ID மூலம் பணம் அனுப்ப பயன்படுகிறது.",
        gyani_virtugullak:"VirtuGullak உங்கள் டிஜிட்டல் சேமிப்பு பாத்திரம். 6.5% ஆண்டு வட்டியுடன் சேமிக்கவும்.",
        gyani_virtu_loans:"Virtu-Loans சிறு தொழிலதிபர்கள் மற்றும் விவசாயிகளுக்கானது.",
        gyani_virtu_cards:"Virtu-Cards இல் Debit Card உடனடியாக கிடைக்கும். Credit Card-க்கு 850+ score வேண்டும்." },
  ml: { nav_login:"ലോഗിൻ", nav_join:"ചേരുക", sign_in:"ലോഗിൻ ചെയ്യുക",
        trust_score:"വിർതു-ട്രസ്റ്റ് സ്കോർ", send_money:"പണം അയയ്ക്കുക",
        virtu_loans:"വിർതു-ലോണുകൾ", emergency_fund:"അടിയന്തര ഫണ്ട്",
        kisan_sahayata:"കിസാൻ സഹായ", laghu_vyapaar:"ലഘു വ്യാപാർ",
        gyani_send_money:"Send Money ഉപയോഗിച്ച് VirtuBank UID അല്ലെങ്കിൽ UPI ID-ലേക്ക് ഉടനടി ട്രാൻസ്ഫർ ചെയ്യാം.",
        gyani_virtugullak:"VirtuGullak നിങ്ങളുടെ ഡിജിറ്റൽ ഗുൽലക് ആണ്. 6.5% വാർഷിക പലിശയോടെ സേവ് ചെയ്യാം.",
        gyani_virtu_loans:"Virtu-Loans ചെറുകിട ബിസിനസ്സ് ഉടമകൾക്കും കർഷകർക്കും ആണ്.",
        gyani_virtu_cards:"Virtu-Cards-ൽ ഡെബിറ്റ് കാർഡ് ഉടനടി ലഭ്യമാകും. ക്രെഡിറ്റ് കാർഡിന് 850+ സ്കോർ ആവശ്യമാണ്." },
  kn: { nav_login:"ಲಾಗಿನ್", nav_join:"ಸೇರಿ", sign_in:"ಸೈನ್ ಇನ್",
        trust_score:"ವಿರ್ತು-ಟ್ರಸ್ಟ್ ಸ್ಕೋರ್", send_money:"ಹಣ ಕಳುಹಿಸಿ",
        virtu_loans:"ವಿರ್ತು-ಸಾಲಗಳು", emergency_fund:"ತುರ್ತು ನಿಧಿ",
        kisan_sahayata:"ಕಿಸಾನ್ ಸಹಾಯತ", laghu_vyapaar:"ಲಘು ವ್ಯಾಪಾರ",
        gyani_send_money:"Send Money ಮೂಲಕ VirtuBank UID ಅಥವಾ UPI ID ಗೆ ತ್ವರಿತವಾಗಿ ಹಣ ಕಳುಹಿಸಿ.",
        gyani_virtugullak:"VirtuGullak ನಿಮ್ಮ ಡಿಜಿಟಲ್ ಗಲ್ಲಕ್. 6.5% ವಾರ್ಷಿಕ ಬಡ್ಡಿಯೊಂದಿಗೆ ಉಳಿಸಿ.",
        gyani_virtu_loans:"Virtu-Loans ಸಣ್ಣ ವ್ಯಾಪಾರಿಗಳು ಮತ್ತು ರೈತರಿಗಾಗಿ.",
        gyani_virtu_cards:"Debit Card ತಕ್ಷಣ ಲಭ್ಯ. Credit Card ಗೆ 850+ ಸ್ಕೋರ್ ಬೇಕು." },
  mr: { nav_login:"लॉगिन", nav_join:"सामील व्हा", sign_in:"साइन इन",
        trust_score:"विर्तु-ट्रस्ट गुण", send_money:"पैसे पाठवा",
        virtu_loans:"विर्तु-कर्ज", emergency_fund:"आपत्कालीन निधी",
        kisan_sahayata:"किसान सहायता", laghu_vyapaar:"लघु व्यवसाय",
        gyani_send_money:"पैसे पाठवण्यासाठी VirtuBank UID किंवा UPI ID वापरा.",
        gyani_virtugullak:"VirtuGullak ही तुमची डिजिटल गुल्लक आहे. 6.5% वार्षिक व्याजासह बचत करा.",
        gyani_virtu_loans:"Virtu-Loans लहान व्यावसायिक आणि शेतकऱ्यांसाठी आहे.",
        gyani_virtu_cards:"Debit Card लगेच मिळतो. Credit Card साठी 850+ गुण हवेत." },
  gu: { nav_login:"લૉગિન", nav_join:"જોડાઓ", sign_in:"સાઇન ઇન",
        trust_score:"વિર્તુ-ટ્રસ્ટ સ્કોર", send_money:"પૈસા મોકલો",
        virtu_loans:"વિર્તુ-લૉન", emergency_fund:"કટોકટી ભંડોળ",
        kisan_sahayata:"કિસાન સહાયતા", laghu_vyapaar:"લઘુ વ્યાપાર",
        gyani_send_money:"VirtuBank UID અથવા UPI ID પર ઝડપથી પૈસા મોકલો.",
        gyani_virtugullak:"VirtuGullak તમારી ડિજિટલ ગુલ્લક છે. 6.5% વાર્ષિક વ્યાજ સાથે બચત કરો.",
        gyani_virtu_loans:"Virtu-Loans નાના વ્યાપારીઓ અને ખેડૂતો માટે છે.",
        gyani_virtu_cards:"Debit Card તરત મળે. Credit Card માટે 850+ સ્કોર જોઈએ." },
  bn: { nav_login:"লগইন", nav_join:"যোগ দিন", sign_in:"সাইন ইন",
        trust_score:"ভির্তু-ট্রাস্ট স্কোর", send_money:"টাকা পাঠান",
        virtu_loans:"ভির্তু-লোন", emergency_fund:"জরুরি তহবিল",
        kisan_sahayata:"কিষান সহায়তা", laghu_vyapaar:"লঘু ব্যবসা",
        gyani_send_money:"VirtuBank UID বা UPI ID-তে তাৎক্ষণিক টাকা পাঠান।",
        gyani_virtugullak:"VirtuGullak আপনার ডিজিটাল গুল্লক। 6.5% বার্ষিক সুদে সঞ্চয় করুন।",
        gyani_virtu_loans:"Virtu-Loans ক্ষুদ্র ব্যবসায়ী ও কৃষকদের জন্য।",
        gyani_virtu_cards:"Debit Card সাথে সাথে পাবেন। Credit Card-এর জন্য 850+ স্কোর দরকার।" },
  pa: { nav_login:"ਲੌਗਿਨ", nav_join:"ਜੁੜੋ", sign_in:"ਸਾਈਨ ਇਨ",
        trust_score:"ਵਿਰਤੁ-ਟਰੱਸਟ ਸਕੋਰ", send_money:"ਪੈਸੇ ਭੇਜੋ",
        virtu_loans:"ਵਿਰਤੁ-ਕਰਜ਼ੇ", emergency_fund:"ਐਮਰਜੈਂਸੀ ਫੰਡ",
        kisan_sahayata:"ਕਿਸਾਨ ਸਹਾਇਤਾ", laghu_vyapaar:"ਲਘੂ ਵਪਾਰ",
        gyani_send_money:"VirtuBank UID ਜਾਂ UPI ID ਤੇ ਤੁਰੰਤ ਪੈਸੇ ਭੇਜੋ।",
        gyani_virtugullak:"VirtuGullak ਤੁਹਾਡਾ ਡਿਜੀਟਲ ਗੁੱਲਕ ਹੈ। 6.5% ਸਾਲਾਨਾ ਵਿਆਜ ਨਾਲ ਬੱਚਤ ਕਰੋ।",
        gyani_virtu_loans:"Virtu-Loans ਛੋਟੇ ਕਾਰੋਬਾਰੀਆਂ ਅਤੇ ਕਿਸਾਨਾਂ ਲਈ।",
        gyani_virtu_cards:"Debit Card ਤੁਰੰਤ ਮਿਲਦਾ ਹੈ। Credit Card ਲਈ 850+ ਸਕੋਰ ਚਾਹੀਦਾ ਹੈ।" },
  as: { nav_login:"লগইন", nav_join:"যোগ দিয়ক", sign_in:"চাইন ইন",
        trust_score:"ভাৰ্তু-ট্ৰাষ্ট স্কোৰ", send_money:"টকা পঠাওক",
        gyani_send_money:"VirtuBank UID বা UPI ID লৈ তাৎক্ষণিকভাৱে টকা পঠাওক।",
        gyani_virtugullak:"VirtuGullak আপোনাৰ ডিজিটেল গুল্লক। 6.5% বাৰ্ষিক সুদেৰে সঞ্চয় কৰক।",
        gyani_virtu_loans:"Virtu-Loans ক্ষুদ্ৰ ব্যৱসায়ী আৰু কৃষকৰ বাবে।",
        gyani_virtu_cards:"Debit Card তাৎক্ষণিকভাৱে পাব। Credit Card-ৰ বাবে 850+ স্কোৰ লাগিব।" },
  fr: { nav_login:"Connexion", nav_join:"Rejoindre", sign_in:"Se connecter",
        trust_score:"Score de Confiance Virtu", send_money:"Envoyer de l'argent",
        virtu_loans:"Virtu-Prêts", emergency_fund:"Fonds d'urgence",
        kisan_sahayata:"Aide Kisan", laghu_vyapaar:"Petite Entreprise",
        gyani_send_money:"Envoyez de l'argent instantanément via UID VirtuBank ou UPI.",
        gyani_virtugullak:"VirtuGullak est votre tirelire numérique avec 6,5% d'intérêt annuel.",
        gyani_virtu_loans:"Virtu-Prêts sont conçus pour les petites entreprises et les agriculteurs.",
        gyani_virtu_cards:"La carte de débit est disponible immédiatement. La carte de crédit nécessite un score 850+." },
  de: { nav_login:"Anmelden", nav_join:"Beitreten", sign_in:"Einloggen",
        trust_score:"Virtu-Vertrauenspunkt", send_money:"Geld senden",
        virtu_loans:"Virtu-Kredite", emergency_fund:"Notfallfonds",
        kisan_sahayata:"Kisan-Hilfe", laghu_vyapaar:"Kleinunternehmen",
        gyani_send_money:"Senden Sie sofort Geld über VirtuBank UID oder UPI ID.",
        gyani_virtugullak:"VirtuGullak ist Ihr digitales Sparschwein mit 6,5% Jahreszins.",
        gyani_virtu_loans:"Virtu-Kredite sind für Kleinunternehmer und Landwirte gedacht.",
        gyani_virtu_cards:"Die Debitkarte ist sofort verfügbar. Die Kreditkarte benötigt 850+ Punkte." },
  ru: { nav_login:"Войти", nav_join:"Присоединиться", sign_in:"Войти",
        trust_score:"Virtu-Рейтинг доверия", send_money:"Отправить деньги",
        virtu_loans:"Virtu-Кредиты", emergency_fund:"Экстренный фонд",
        kisan_sahayata:"Помощь Кисан", laghu_vyapaar:"Малый бизнес",
        gyani_send_money:"Мгновенно отправляйте деньги через UID VirtuBank или UPI.",
        gyani_virtugullak:"VirtuGullak — ваша цифровая копилка с 6,5% годовых.",
        gyani_virtu_loans:"Virtu-Кредиты предназначены для малого бизнеса и фермеров.",
        gyani_virtu_cards:"Дебетовая карта доступна сразу. Кредитная карта требует 850+ баллов." }
};
